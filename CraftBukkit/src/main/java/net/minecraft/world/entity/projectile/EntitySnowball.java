...
public class EntitySnowball extends EntityProjectileThrowable {
    ...
    public EntitySnowball(World world, EntityLiving entityliving, ItemStack itemstack) {
        super(EntityTypes.SNOWBALL, entityliving, world, itemstack);
    }

    public EntitySnowball(World world, double d0, double d1, double d2, ItemStack itemstack) {
        super(EntityTypes.SNOWBALL, d0, d1, d2, world, itemstack);
    }
