...
public class TileEntityBeehive extends TileEntity {
    ...
    protected void loadAdditional(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        (nbttagcompound.read("bees", TileEntityBeehive.c.LIST_CODEC).orElse(List.of())).forEach(this::storeBee); // CraftBukkit - decompile error
        ...
        // CraftBukkit start
        this.maxBees = nbttagcompound.getIntOr("Bukkit.MaxEntities", this.maxBees);
        // CraftBukkit end
    }
